...
1. **Maximum predictiveness** — as accurate as possible; use every exactness-preserving technique at our disposal (the gap-closing playbook plus the 229-technique inventory). Headliners: quantized histograms, MVS sampling, fully-corrective refit, Nesterov/AGBM, the interaction-selection funnel, and bagged ensemble selection.
